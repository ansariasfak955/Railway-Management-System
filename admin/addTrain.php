...
<section class="section profile">
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Add Train</button>
                </li>
              </ul>
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade  show active profile-edit pt-3" id="profile-edit">
                  ...
                  ?>
                  <form action="train_action.php" method="POST">
                    <div class="row mb-3">
                      <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Train Name</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="trainName" type="text" class="form-control" id="trainName">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Total Seats</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="total_seats" type="text" class="form-control" id="total_seats">
                      </div>
                    </div>
    ...
    include '../assets/inc/conn.php';
     ...
     $total_sql = "SELECT COUNT(*) AS total FROM trains";
     $total_result = $conn->query($total_sql);
     $total_row = $total_result->fetch_assoc();
     $total_records = $total_row['total'];
     $total_pages = ceil($total_records / $records_per_page);

    //  $sql = "SELECT * FROM trains LIMIT $records_per_page OFFSET $offset";
    $sql = "SELECT * FROM trains 
        JOIN seats ON trains.id = seats.train_id
